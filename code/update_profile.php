...
if (isset($_POST['update_profile'])) {
   ...
   $update_hight = mysqli_real_escape_string($conn, $_POST['update_hight']);
   $update_weight = mysqli_real_escape_string($conn, $_POST['update_weight']);

   mysqli_query($conn, "UPDATE `user_form` SET name = '$update_name', email = '$update_email' , age='$update_age',hight='$update_hight', weight='$update_weight'  WHERE id = '$user_id'") or die('query failed');
         ...
         <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="flex">
               <div class="inputBox">
                  ...
                  <span> Hight :</span>
                  <input type="text" name="update_hight" value="<?php echo $fetch['hight']; ?>" class="box">
                  <span>Weight :</span>
